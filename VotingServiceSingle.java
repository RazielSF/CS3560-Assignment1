...
//For Questions that accept only 1 answer
public class VotingServiceSingle implements VotingService
{
    ...
    public void acceptSubmissions(ArrayList<Student> answerList, Question q)
    {
        ...
        //Counts which answer number did the student submit
        for(int a = 0; a < answerList.size(); a++)
        {
            int ansNum = answerList.get(a).getStudentAnswers().get(0).getAnswerNumber() - 1;
